    ...
    function consultar(){
      ...
      $.post("includes/_funciones.php", obj, function(respuesta){
        ...
        $.each(respuesta,function(i,e){
          ...
          <td>${e.subtitu_img_wwd}</td>
          <td>${e.bton_wwd}</td>
          <td>
          <a href="#" data-id="${e.id_wwd}" class="editar_registro">Editar</a>
          <a href="#" data-id="${e.id_wwd}" class="eliminar_registro">Eliminar</a>
          </td>
          </tr>
          `;
        });
...
//editar registro
$('#list-wwd').on("click",".editar_registro", function(e){
        e.preventDefault();
        let id = $(this).data('id'),
            obj = {
